...
import com.example.autorenter.ui.othersProfile.SectionsPagerAdapter;
import com.google.android.material.tabs.TabLayout;
import androidx.viewpager.widget.ViewPager;
import androidx.appcompat.app.AppCompatActivity;
import com.example.autorenter.databinding.ActivityOthersProfileBinding;
...
public class OthersProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityOthersProfileBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        SectionsPagerAdapter sectionsPagerAdapter = new SectionsPagerAdapter(this, getSupportFragmentManager());
        ViewPager viewPager = binding.othersProfileViewPager;
        viewPager.setAdapter(sectionsPagerAdapter);
        TabLayout tabs = binding.othersProfileTabs;
        ...
        // Notification of "User not found" and finish activity.
        if (userID == null) {
            Context context = getApplicationContext();
            CharSequence ToastTextMsg = "User not found";
            Toast toast = Toast.makeText(context, ToastTextMsg, Toast.LENGTH_SHORT);
            toast.show();
            finish();
        }
        usernameView = (TextView) findViewById(R.id.othersProfileUsrName);
        joined_dateView = (TextView) findViewById(R.id.othersProfileJoinDate);
        profile_picView = (ImageButton) findViewById(R.id.othersProfileIcon);

        listingNum = (TextView) findViewById(R.id.othersProfileListNo);

        star1 = (ImageView) findViewById(R.id.othersProfileStar1);
        star2 = (ImageView) findViewById(R.id.othersProfileStar2);
        star3 = (ImageView) findViewById(R.id.othersProfileStar3);
        star4 = (ImageView) findViewById(R.id.othersProfileStar4);
        star5 = (ImageView) findViewById(R.id.othersProfileStar5);
        stars = new ImageView[]{star1, star2, star3, star4, star5};
        NumberOfRating = (TextView) findViewById(R.id.othersProfileRateNo);
